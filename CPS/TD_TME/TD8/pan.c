...
short src_ln0 [] = {
	  0,  12,  13,  15,  15,  15,  16,  16, 
	 14,  19,  20,  22,  22,  23,  23,  24, 
	 24,  21,  27,  28,  30,  30,  31,  31, 
	 32,  32,  29,  35,  36,  38,  38,  39, 
	 39,  40,  40,  37,  43,  44,  47,  49, 
	 49,  48,  52,  52,   0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "feu.pml", 1, 43 },
...
{	int j, h = now._nr_pr;
	...
	case 0:	/* feu */
		...
		/* params: */
		/* locals: */
		((P0 *)pptr(h))->clignotant = 0;
		((P0 *)pptr(h))->couleur = 1;
#ifdef VAR_RANGES
		logval("feu:clignotant", ((P0 *)pptr(h))->clignotant);
		logval("feu:couleur", ((P0 *)pptr(h))->couleur);
#endif
#ifdef HAS_CODE
		locinit0(h);
#endif
...
{
	switch (x) {
	case 1: Printf("IND"); break;
	case 2: Printf("ORANGE"); break;
	case 3: Printf("ROUGE"); break;
